  ...
  <div className="fixed right-4 md:right-6 bottom-24 flex flex-col gap-3 z-50">
    ...
    <div className="relative group">
      <a
        ...
        aria-label="Call us"
        className="flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full shadow-lg bg-gradient-to-br from-blue-500 to-blue-600 text-white transition-transform duration-200 hover:scale-110"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
