...
import { assets, maternityImages } from "../assets/assets";
...
const Maternity = () => {
	...
	const imageUrls = maternityImages.map(img => assets[img.src]).filter(Boolean);
				...
				<div className="mx-auto max-w-6xl px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24">
					<div className="mb-16">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
							{maternityImages.length === 0 && (
								<p className="col-span-full text-center text-gray-500">Images coming soon.</p>
							)}
